    ...
    partial class Program
    {
        ...
        static class MFDFrame
        {
                ...
                bool compact = false)
            {
                ...
                Txt("TAC " + Jet.IC + "/" + Jet.IA + "/" + Jet.IP, padX + corpW, hy + headerH * 0.22f, smallScale, MFDTheme.MID_TEXT);

                // Header right text
                if (headerRight != null)
                {
                    Txt(headerRight, sw - padX, hy + headerH * 0.2f, smallScale,
                ...
                if (!SE(footerRight))
                    Txt(footerRight, sw - padX, fy + footerH * 0.15f,
