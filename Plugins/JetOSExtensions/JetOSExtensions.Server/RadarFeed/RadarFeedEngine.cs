...
namespace JetOSRadarFeed
{
    public sealed class RadarFeedEngine
    {
        ...
        const string PropertyName = RadarFeedProtocol.PropertyName;
        const string Header = RadarFeedProtocol.Header;
        const int FeedVersion = RadarFeedProtocol.FeedVersion;
        ...
        public bool PropertyRegistered => _propertyRegistered;
        public long Sequence => _sequence;
        public int ConstructFeedCount => _constructFeeds.Count;
        ...
        {
            return new StringBuilder(RadarFeedProtocol.EmptyFeed(_sequence));
        }
        ...
        {
            return RadarFeedProtocol.Sanitize(value);
        }
        ...
        {
            return RadarFeedProtocol.FormatContactLine(kind, entityId, name, px, py, pz, vx, vy, vz);
        }

        static void AppendDouble(StringBuilder sb, double value)
        {
            RadarFeedProtocol.AppendDouble(sb, value);
        }
