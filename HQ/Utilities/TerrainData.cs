...
namespace IngameScript
{
    ...
    {
        // Downloads the entire planet heightmap over the session via the TerrainAPI mod property
        // on the PB, then provides instant offline lookups. Ported verbatim from the jet's
        // Utilities/TerrainData.cs (it only depends on shared shortcuts + the TERRAIN_API const).
